...
file_path_target = r'C:\Users\he kelly\Desktop\Fixed Assets\FA Register\202307\Acc Dep\leasehold and furniture v2.xlsx'
file_path_source = r'C:\Users\he kelly\Desktop\Fixed Assets\FA Register\202307\Acc Dep\PRC Fixed Assets Register 2023.04.xlsx'
register_new = pd.read_excel(file_path_target, header=0, sheet_name='Sheet1')
print(register_new.columns)
register_source = pd.read_excel(file_path_source, sheet_name='F&F', header=5)
print(register_source)
register_target = register_new[register_new[r"资产类型(必填)"] == 'Furniture']
...
for mapping in list_mapping:
    if mapping in list_pass:
        ...
        print(mapping)
        accDep = register_source.loc[register_source['Mapping'] == f'{mapping}', 'Accumulated Depreciation till Dec 2022'].sum()
...
#     accDep_invoice = df_source_invoice['Accumulated Depreciation till Dec 2022'].sum()
...
register_new.to_excel(r'C:\Users\he kelly\Desktop\Fixed Assets\FA Register\202307\Acc Dep\leasehold and furniture v3.xlsx')

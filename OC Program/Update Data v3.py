...
# #从更新的大表姐中提取dataframe
file_path_source = r'C:\Users\he kelly\Downloads\GL Dump query Jun.16 _ with RU and Currency Conversion SZ 2023.4-5 USD v2.xlsx'
df_source = pandas.read_excel(file_path_source, sheet_name="Drill", header=1)

# #提取原文件中的dataframe

file_path_target = r'C:\Users\he kelly\Desktop\OC\2023\SZ.xlsx'

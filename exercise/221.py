...
file_path_bank = r'C:\Users\he kelly\Desktop\Bank reconciliation\202302\HSBC TW.xlsx'
file_path_APmapping = r'C:\Users\he kelly\Desktop\Bank reconciliation\202301\AP Mapping.xlsx'
file_path_GL = r'C:\Users\he kelly\Desktop\Bank reconciliation\202302\GL JAN-FEB TW.xlsx'
...
pro_glData_employee = glData_employee.groupby("Vendor Name")
Code = str(glData['Entity Cd'].iloc[1])

record_gl_E = []
record_bk_E = []

for i, j in pro_glData_employee:
        ...
        for subset in subsets_Bank:
            ...
            if len(subset) >= 1:
                for index in subset:
                    ...
                    value = bank['Credit/Debit amount + 30']
                    subsetSum += value
...
for i in record_bk_E:
    for j in i:
        cellBank = sheetBank.cell(j+2, sheetBank.max_column-3)
...
for i in record_gl_E:
    for j in i:
        cellGL = sheetGL.cell(j+2, sheetGL.max_column)
